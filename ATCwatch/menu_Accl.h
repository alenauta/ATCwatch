...
public:
  virtual void pre()
  {
    ...
    lv_obj_align(label_z, LV_ALIGN_TOP_LEFT, 10, 65);
    label_temp = lv_label_create(lv_scr_act());
    lv_obj_align(label_temp, LV_ALIGN_TOP_LEFT, 10, 85);

    // label_steps = lv_label_create(lv_scr_act());
    // lv_label_set_text(label_steps, "Steps:");
    // lv_obj_align(label_steps, NULL, LV_ALIGN_TOP_LEFT, 10, 105);
    // label_activity = lv_label_create(lv_scr_act());
    // lv_label_set_text(label_activity, "Activity:");
    // lv_obj_align(label_activity, NULL, LV_ALIGN_TOP_LEFT, 10, 125);
